    ...
    <>
      ...
      >
        ...
        <div className="relative min-h-0 flex-1 lg:py-0  lg:pt-24">
          ...
          >
            <div className="relative flex h-full w-full items-center justify-start lg:pb-32 3xl:translate-x-50">
              ...
              <div className="hidden text-white lg:block ml-80">{BgLoop(item.text, ctaRef)}</div>
            </div>
            {hasContentBelow && (
