import { User, PaperPlaneTilt, FileDotted, Eye, EyeSlash, EnvelopeSimple } from 'phosphor-react';
...
const FeatureSection = () => {
  ...
  return (
    <div
      className="relative z-10 flex w-screen flex-col items-center justify-center bg-white
    ...
    >
      ...
      <RevealY className="grid grid-cols-1 flex-row flex-wrap justify-center gap-8 sm:grid-cols-2">
        {cards.map((card) => (
          <div
            className="flex flex-col items-start justify-start space-y-6 rounded-2xl bg-gray-1
