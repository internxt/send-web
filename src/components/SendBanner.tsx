  ...
  return (
    ...
    >
      <div
        ...
        w-auto max-w-[800px] -translate-y-1/2 -translate-x-1/2 transform
        flex-col rounded-2xl bg-black text-neutral-900`}
        style={{
        ...
        <div className="flex flex-col space-x-20 p-14 lg:flex-row lg:p-20">
          <div className="flex w-full flex-col items-center justify-center text-center lg:items-start lg:text-left">
            ...
            <div className="flex pt-6">
              <button
                className="relative flex h-14 w-48 flex-row items-center justify-center space-x-4 rounded-full
                  bg-primary px-8 text-base text-white transition duration-100 focus:outline-hidden
                  focus-visible:bg-primary-dark active:bg-primary-dark sm:text-lg"
                onClick={() => {
