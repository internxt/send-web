  ...
  return (
    ...
    >
      <div
        className={`${
          props.sendBannerVisible ? "flex" : "hidden"
        } absolute top-1/2 left-1/2 flex
        w-auto max-w-[800px] -translate-y-1/2 -translate-x-1/2 transform flex-col rounded-2xl bg-black text-neutral-900`}
        style={{
      ...
      >
        <button
          className="absolute right-0 m-7 flex w-auto text-white"
          onClick={onClose}
        >
          <X size={32} />
        </button>
        <div className="flex flex-col space-x-20 p-14 lg:flex-row lg:p-20">
          <div className="flex w-full flex-col items-center justify-center text-center lg:items-start lg:text-left">
            <div className="flex max-w-[323px] flex-col items-start">
              <p className="text-5xl font-bold text-white lg:w-48">
                Try out Internxt
              </p>
