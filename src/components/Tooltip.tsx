...
export default function Tooltip({
  ...
  return (
    <div className={`xs:w-72 ${show ? 'flex' : 'hidden'} w-max ${className} absolute z-40`} style={{ lineHeight: 0 }}>
      <div
        className={`pointer-events-none transform ${tooltipPosition} flex items-center ${
          trianglePosition
        } transition-all duration-150 ${style === 'light' ? 'drop-shadow-tooltip filter' : ''}`}
      >
        <div
