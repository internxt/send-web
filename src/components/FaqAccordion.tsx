...
const FaqAccordion = ({ question, answer }: Props) => {
  ...
  return (
    <div className="flex flex-col items-stretch justify-start">
      ...
      >
        <span className="w-full text-lg font-medium sm:text-lg md:text-xl">
          {question}
        </span>
        <PlusCircle
          size={32}
      ...
      <span
        ...
        } w-full whitespace-pre-wrap pr-14 text-left text-lg text-gray-60 transition-all duration-250 ease-in-out`}
      >
