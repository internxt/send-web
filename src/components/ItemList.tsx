...
function Item({ item, onRemove }: { item: SendItemData; onRemove?: (item: SendItemData) => void }) {
  ...
  return (
    <div className="group relative border-b border-gray-5 py-2.5">
      <p className="truncate text-base text-gray-80">{item.name}</p>
      ...
      {onRemove && (
        <button
          className="absolute right-0 top-0 flex h-full items-center justify-end bg-linear-to-r from-transparent
            via-gray-1 to-gray-1 pl-12 lg:hidden lg:group-hover:flex"
